...
public class AddPackage extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("INSERT INTO `package`(`ID`, `Minutes`, `Texts`, `Name`, `Price`, `Quantity`)" + " VALUES  (?,?,?,?,?,?)");
        ...
        JOptionPane.showMessageDialog(rootPane, "Package data added sucessfully", "Add Package", JOptionPane.INFORMATION_MESSAGE);
