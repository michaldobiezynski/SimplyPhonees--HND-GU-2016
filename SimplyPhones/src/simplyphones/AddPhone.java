...
public class AddPhone extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            //Prepare insert query, to insert phone data into database
            PreparedStatement ps = con.prepareStatement("INSERT INTO `phone`(`ID`, `Model`, `Title`, `Manufacturer`, `Price`, `Quantity`)" + " VALUES  (?,?,?,?,?,?)");

            //Insert phone data into database
            ps.setInt(1, id);
            ...
            Logger.getLogger(AddPhone.class.getName()).log(Level.SEVERE, null, ex);
        }
        //Give the confirmation to user that phone data sucessfully added to database
        JOptionPane.showMessageDialog(rootPane, "Phone data added sucessfully", "Add Phone", JOptionPane.INFORMATION_MESSAGE);

        //After addin data to DB, reset the text fields to empty
        jTextField1.setText("");
        jTextField2.setText("");
        jTextField3.setText("");
        jTextField4.setText("");
